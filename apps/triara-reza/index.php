<?php
include('../triara-reza/koneksi.php');
?>
<!DOCTYPE html>
<html lang="en-US">
...
<head>
	<meta name="description" content="Undangan pernikahan Triara dan Reza. Senin, 18 Oktober 2021.">
	<meta property="og:title" content="Undangan pernikahan Triara dan Reza. Senin, 18 Oktober 2021." />
	<meta property="og:url" content="https://Triara-Reza.digital-invitation.com/" />
	<meta property="og:description" content="Undangan pernikahan Triara dan Reza. Senin, 18 Oktober 2021.">
	<meta property="og:image" content="https://Triara-Reza.digital-invitation.com/1.bp.blogspot.com/-FuprKxe6I3I/X3waINlnqnI/AAAAAAAAFzo/DF1N99KVgt8ZjEiaNubMyRjz17nxGNAxQCLcBGAsYHQ/s16000/AZ--531.jpg">
        ...
        $('#welcome-gate').addClass('move-gate');
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						<h4 class="et_pb_module_header" ><span style="font-family:'Vibur',cursive">Triara & Reza</span></h4>
						<div class="et_pb_blurb_description"><p style="text-align: center;">18 Oktober 2021</p></div>
...
<p>( QS. Ar- Rum 21 )</p></div>
			...
			<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
				...
				<div class="et_pb_text_inner">
					<h1>Triara Anggarisa</h1>
                	<p><strong>Putri dari</strong><br> Bpk. H. Iryanto (Alm)<br> &amp; Ibu Cicih Kurniasih, S.Pd.</p>
				</div>
			</div> <!-- .et_pb_text -->
				...
				<div class="et_pb_text_inner">
					<h1>Reza Nazarrudin Firmansyah</h1>
                    <p><strong>Putra dari</strong><br> Bpk. Tarma, S.Pd.<br> &amp; Ibu Kesih Sukaesih, S.Pd.</p>
				</div>
			</div> <!-- .et_pb_text -->
			</div> <!-- .et_pb_column -->
				...
				<div class="et_pb_module et_pb_countdown_timer et_pb_countdown_timer_0 et_pb_no_bg et_pb_bg_layout_light" data-end-timestamp="1634522400">
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description">
							<p>Senin, 18 Oktober 2021<br> 09.00 s/d 11.00 WIB<br> <strong>Kediaman Mempelai Wanita</strong><br> Lingk. Manis RT 30 RW 11, Cigugur,<br> Kab. Kuningan, Jawa Barat</p>
						</div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
				...
				<div class="et_pb_blurb_content">
					...
					<div class="et_pb_blurb_container">
						...
						<div class="et_pb_blurb_description">
							<p>Senin, 18 Oktober 2021<br> 11.00 s/d 15.00 WIB<br> <strong>Kediaman Mempelai Wanita</strong><br> Lingk. Manis RT 30 RW 11, Cigugur,<br> Kab. Kuningan, Jawa Barat</p>
						</div>
					</div>
				</div> <!-- .et_pb_blurb_content -->
			</div> <!-- .et_pb_blurb -->
				...
				<a class="et_pb_button et_pb_button_1 et_animated et_pb_bg_layout_light" href="https://goo.gl/maps/8sfAiiy7xhXBJLQb8" target="_blank" style="background-color: #a87850!important;">Google Maps</a>
			</div>
			</div> <!-- .et_pb_column -->
	...
	<div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular" >
			...
			<div id="et_pb_contact_form_0" class="et_pb_module et_pb_contact_form_0 et_pb_contact_form_container clearfix" >
				...
				<div class="et_pb_contact">
					<form method="post" action="../triara-reza/tambah_pesan.php">
